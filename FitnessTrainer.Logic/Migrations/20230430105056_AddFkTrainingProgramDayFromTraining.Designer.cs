...
namespace TrainingManager.Logic.Migrations
{
    ...
    [Migration("20230430105056_AddFkTrainingProgramDayFromTraining")]
    partial class AddFkTrainingProgramDayFromTraining
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainingManager.Logic.Storage.Domain.Category", b =>
                {
            ...
            modelBuilder.Entity("TrainingManager.Logic.Storage.Domain.ObjectOfStatistics", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TrainingManager.Logic.Storage.Domain.StatisticsIndicator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<DateTime>("CreatedOrUpdate")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.ToTable("StatisticsIndicators");
                });
            ...
            modelBuilder.Entity("TrainingManager.Logic.Storage.Domain.StatisticsIndicator", b =>
                {
                    b.HasOne("TrainingManager.Logic.Storage.Domain.ObjectOfStatistics", "ObjectOfStatistics")
                        .WithMany("StatisticsIndicators")
                        .HasForeignKey("ObjectCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ObjectOfStatistics");
                });
            ...
            modelBuilder.Entity("TrainingManager.Logic.Storage.Domain.ObjectOfStatistics", b =>
                {
                    b.Navigation("StatisticsIndicators");
                });
