...
namespace TrainingManager.Logic.Migrations
{
    ...
    [Migration("20221026202901_addNewFieldsAndFixTrainingAproach")]
    partial class addNewFieldsAndFixTrainingAproach
    {
            ...
            modelBuilder.Entity("TrainingManager.Logic.Storage.Domain.Exercise", b =>
                {
                    ...
                    b.Property<Guid?>("TrainingProgramDayId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TrainingProgramDayId");
            ...
            modelBuilder.Entity("TrainingManager.Logic.Storage.Domain.Exercise", b =>
                {
                    ...
                    b.HasOne("TrainingManager.Logic.Storage.Domain.TrainingProgramDay", null)
                        .WithMany("Exercises")
                        .HasForeignKey("TrainingProgramDayId");
